  ...
  return (
    <div className="bg-[#140e24] border border-purple-950/40 rounded-2xl overflow-hidden shadow-xl hover:border-purple-800/40 transition-all duration-300 flex flex-col group">
      ...
      <div className="p-5 flex flex-col flex-grow justify-between space-y-4">
        ...
        <button
          onClick={() => navigate(`/customer/booking/${artist.id}`)}
          className="w-full bg-violet-600 hover:bg-violet-500 text-white font-medium text-sm py-2.5 px-4 rounded-xl shadow-lg shadow-violet-950/20 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-[#0d081b]"
        >
          Select Artist
        </button>
      </div>
